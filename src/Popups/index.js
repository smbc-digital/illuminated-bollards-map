...
const bollardActivePopup = feature => {
  ...
  <a class="button-primary" href="${varName}/lit-sign-bollard/report-an-issue/lit-bollard/fault-type?assetId=${feature.properties.central_asset_id}&siteCode=${feature.properties.site_code}">Report this bollard</a>`
}
