...
import { illuminatedbollardPopup} from './Popups' //devsitesPopup, notdevsitesPopup}
import { illuminatedbollardStyle} from './Styles'
...
const Configuration = {
    ...
    [
...

        {
            ...
            layerOptions: {
                maxZoom: 16,
                onEachFeature: illuminatedbollardPopup,
                pointToLayer: (feature, latlng) => {
                    return Leaflet.circleMarker (latlng, illuminatedbollardStyle (feature))
